                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="line-height: 140%;"><strong>Hi
                                                                        {{ $firstname }}!</strong></p>
                                                            </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                <p style="line-height: 140%;">Your order will be
                                                                    dispatched soon.</p>
                                                            </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                <p style="line-height: 140%;"><strong>Order ID
                                                                        : {{ $orderId }}</strong></p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="line-height: 140%;"><strong>Order
                                                                        Details</strong></p>
                                                                <?php $sn = 1; ?>
                                                                @foreach ($orderDetails as $item)
                                                                    <p style="line-height: 140%;">{{ $sn++ }}.
                                                                        {{ $item->product_name }} -
                                                                        {{ $item->product_size }} -
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                style="font-size: 14px; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                <p style="line-height: 140%;">Sub-total =
                                                                    £{{ $subTotal }}</p>
                                                            </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                style="font-size: 14px; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                <p style="line-height: 140%;"><strong>Delivery
                                                                        Details</strong></p>
                                                                <p style="line-height: 140%;">Email :
                                                                    {{ $email }}</p>
                                                                <p style="line-height: 140%;">Phone :
                                                                    {{ $phone }}</p>
                                                                <p style="line-height: 140%;">Address :
                                                                    {{ $address }}</p>
                                                                <p style="line-height: 140%;">Delivery Fee :
                                                                    £{{ $deliveryFee }}</p>
                                                            </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                style="font-size: 14px; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                <p style="line-height: 140%;">Grand Total =
                                                                    £{{ $grandTotal }}</p>
                                                                <p style="line-height: 140%;">Payment status =
                                                                    {{ $paymentStatus }}</p>
                                                            </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                style="font-size: 14px; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                <p style="line-height: 140%;"><strong>Thank you for
                                                                        purchasing from sapientculture.com!</strong></p>
                                                            </div>
